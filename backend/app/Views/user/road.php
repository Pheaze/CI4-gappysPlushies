...
<?= view('user/road', [
  'phases' => [
    ['title' => 'Design', 'description' => 'Wireframes and UI design', 'date' => '2024-06', 'status' => 'done'],
    ['title' => 'Development', 'description' => 'Core features and backend', 'date' => '2024-07', 'status' => 'in-progress'],
    ['title' => 'Testing', 'description' => 'QA and bug fixes', 'date' => '2024-08', 'status' => 'planned'],
    ['title' => 'Launch', 'description' => 'Go live!', 'date' => '2024-09', 'status' => 'planned'],
  ]
]) ?>
--></svg></li>